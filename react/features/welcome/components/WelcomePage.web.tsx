...
import { generateProgrammingRoomName } from '../../base/util/programmingRoomNameGenerator';
...
class WelcomePage extends AbstractWelcomePage<IProps> {
     ...
     * @returns {void}
     */
    override _updateRoomName() {
        const generatedRoomName = generateProgrammingRoomName();
